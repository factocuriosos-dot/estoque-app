...
export default function Coleta() {
  ...
  // Lista de transportadoras já usadas
  ...
  // Notas coletadas com filtros do histórico
...
<body>
  ...
  return (
    <div>
      ...
      {/* Filtro da aba Agendadas por transportadora */}
      {aba === 'agendada' && (
